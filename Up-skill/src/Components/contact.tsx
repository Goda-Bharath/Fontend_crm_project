...
function Footer() {
  ...
  return (
    <section
      id="contact"
      className="w-full min-h-screen  flex justify-center items-center px-2 py-30"
    >
          ...
          <div className="rounded-3xl p-10 md:p-16 text-white">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-10">
                <div>
                  <h2 className="text-5xl font-bold text-blue-500 mb-3 text-center   ml-50 ">
                    Contact Me
                  </h2>
  ...
  "
                    ...
                    <a
                      href="https://www.linkedin.com/company/skillcapital/mycompany/"
                      target="_blank"
                      rel="noopener noreferrer"
  ...
  ">
            ...
            <p className=" opacity-200 text-white">
